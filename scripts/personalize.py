...
def main(
    ...
    # Rename 'hidir' directory to `package_dir_name`.
    if not dry_run:
        (REPO_BASE / "hidir").replace(REPO_BASE / package_dir_name)
    else:
        print(f"Renaming 'hidir' directory to '{package_dir_name}'")
